// Ricardo Rhone May 21, 2019 Java - Types, Variables Part 2 LAB
...
public class Lab2 {
	...
	public static void playWithStrings() //create another static void method - `playWithStrings()`
	{
		...
		System.out.println("fullName contains a apostrophe?: " + fullName.contains("'")); //does the full name contain an apostrophe or dash?
		System.out.println("fullName contains a dash?: " + fullName.contains("-")); //does the full name contain an apostrophe or dash?
		//Print the above values using format strings, in complete sentence form
		System.out.println("\nPrinted in sentence form: ");
		System.out.println(String.format("The total length of the String %s is %s.\r\nThe String %s has a 'o' in position %s.", fullName, fullName.length(), fullName, fullName.indexOf('o')));
		System.out.println(String.format("The leter in position 7 is %s.\r\nThe String %s does not contain the word 'son'.", fullName.charAt(7), fullName));
		System.out.println(String.format("The last 5 letters of the String %s are%s.\r\nThe String %s does not contain an apostrophe or a dash.", fullName, fullName.substring(fullName.length()-6), fullName));
